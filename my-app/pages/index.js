...
export default function Home() {
  ...
  const getTokensToBeClaimed = async () => {
    try {
      ...
      if (balance === zero) {
        ...
        // Only increase the amount if the token have not been claimed
  ...
  /**
   * getBalanceOfCryptoDevTokens: checks the balance of Crypo Dev Token's held by an address
   */
  ...
  const renderButton = () => {
    ...
    // if the user doesn't have any tokens to claim, show the mint button
    return(
